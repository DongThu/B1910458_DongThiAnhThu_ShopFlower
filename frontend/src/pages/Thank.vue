<template>
    <div class="thank-container">
        ...
        <div class="thank-letter">
            <p v-none>Cảm ơn bạn đã lựa chọn chúng tôi!</p>
            <p v-none>
                Chúng tôi vừa xác nhận rằng bạn đã nhận đơn hàng của bạn, hy vọng bạn thích nó.
                Mọi mặt hàng được đội ngũ của chúng tôi làm thủ công, cẩn thận đến từng chi tiết, 
