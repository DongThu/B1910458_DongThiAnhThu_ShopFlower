        ...
        <div class="login-form-container">
            <form id="loginForm" @submit="handleSubmit" novalidate autocomplete="off">
                ...
                <div class="form-group">
                    <input type="email" id="uEmail" name="uEmail" class="form-control" placeholder="Nhập email của bạn"
                        v-model="loginObj.email" />
                </div>

                <div class="form-group">
                    <input type="password" id="uPass" name="uPass" class="form-control"
                        placeholder="Nhập mật khẩu của bạn" v-model="loginObj.pass" />
                </div>

                <div class="form-group">
                    <input type="submit" value="Đăng nhập" class="btn">
                    <p>Bạn chưa có tài khoản? <router-link @click="scrollToTop()" to="/register">tạo một tài khoản
                        </router-link>
                    </p>
                </div>
            </form>
