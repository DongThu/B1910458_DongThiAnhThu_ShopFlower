<template>
    <div class="my-order-container" :class="filterBills.length > 0 ? '' : 'fit-screen'">
        <div v-if="filterBills.length > 0" class="my-order-cards">
            <div v-for="b in filterBills.slice().reverse()" class="card" :key="b.bill_id">
                ...
                <div class="d-flex flex-wrap flex-sm-nowrap justify-content-between card-summary">
                    <div class="w-100 text-center py-1 px-2"><span>Thanh toán:</span>{{ " " + b.bill_paid }}
                    </div>
                ...
                <div class="d-flex flex-wrap flex-sm-nowrap justify-content-between card-summary">
                    ...
                    <div class="w-100 text-center py-1 px-2"><span>Tổng tiền:</span> ${{ b.bill_total }}</div>
                    <div class="w-100 text-center py-1 px-2"><span>Địa chỉ:</span>{{ " " + b.bill_address }}
                    </div>
                    <div class="w-100 text-center py-1 px-2"><span>Điện thoại:</span>{{ " " + b.bill_phone }}
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="steps d-flex flex-wrap flex-sm-nowrap justify-content-between">
                        ...
                        <div class="step" :class="b.bill_status >= 3 ? 'completed' : ''">
                            ...
                            <h4 class="step-title">Đang kiểm tra</h4>
                        </div>
        ...
        <div v-else class="box-content row no-flower">
            <div class="content">
                <h2 style="color: #057835fa;">Bạn chưa có bất kì đơn đặt hàng nào</h2>
            </div>
            <div>
...
export default {
    ...
    data() {
        return {
            avaiableStatus: ["Hủy", "Đã xác nhận", "Đang chuẩn bị", "Đang kiểm tra", "Đang giao", "Đã giao"],
            allBills: [],
